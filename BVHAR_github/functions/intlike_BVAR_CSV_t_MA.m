% This script evaluates the integrated likelihood of the BVAR-CSV-t-MA model
%
% See:
...
function [intlike,store_llike] = intlike_BVAR_CSV_t_MA(shortY,X,A,Sig,psi,rho,sigh2,nu,R)
[T,n] = size(shortY);
